...
## Respository-specific instructions

This repository is Purdue Analysis Facility - an interactive research environment for high energy physicists. It runs in production in `geddes` context and contained within `cms` namespace. Never use other contexts or namespaces.